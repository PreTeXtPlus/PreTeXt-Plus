...
// This package has no demo/dev app — the Rails host (PreTeXt-Plus) bundles
// this package's source directly via esbuild, and this config exists only
// for the library build (`vite build --mode lib`, producing `dist/`) for any
// future npm-consuming host.
